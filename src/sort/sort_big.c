...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/03 16:48:49 by fporto            #+#    #+#             */
/*   Updated: 2022/03/03 19:51:14 by fporto           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	if (ps->as->size > 0 && ft_abs(ft_stackpeek(ps->as).i) <= 2)
// 		sizea = ft_stackpop(ps->as).i;
// 	else
// 		sizea = 10;
// 	if (ps->bs->size > 0 && ft_abs(ft_stackpeek(ps->bs).i) <= 2)
